...
import { ICouponRedemptionRepository } from '@/application/contracts/i-coupon-redemption-repository.interface';
import { CouponRedemptionDataMapper, CouponRedemptionPersistence } from './data-mappers/coupon-redemption.data-mapper';
