...
/**
 * Componente de Logo do Belezeiro
 */
function BelezeitoLogo() {
  return (
...
/**
 * Componente de imagem lateral (desktop)
 */
      ...
      <div className="absolute bottom-8 left-8 right-8 animate-float">
        <div className="bg-card/90 backdrop-blur-sm rounded-2xl p-6 shadow-card max-w-sm">
          <p className="text-sm text-muted-foreground mb-1">
            Mais de 1.000 profissionais confiam no
          </p>
        ...
        <div className="w-full max-w-md mx-auto space-y-10">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Gerencie sua agenda com tranquilidade. Faça login ou crie sua
              conta para começar.
            </p>
          </div>
